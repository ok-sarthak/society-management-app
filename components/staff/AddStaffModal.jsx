...
export default function AddStaffModal({ visible, onClose, onSuccess, userData }) {
  ...
  useEffect(() => {
    filterMembers();
  }, [members, memberSearchQuery]); // eslint-disable-line react-hooks/exhaustive-deps
